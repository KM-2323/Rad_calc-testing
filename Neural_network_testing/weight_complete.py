...
#From optimizing within pyridine
params_pyridine_cycle = [[ -2.3642073,    4.84619879,   1.06426708 ,  0.        ],
                         [ -3.04092646 , -2.18510501,  13.43082869,   1.09137303],
                         [ -6.74959017 , -1.51729133,   7.01620337 ,  2.40895788],
                         [-11.55884037 , -1.51969241 ,  4.3693188 ,   0.94696079]]
bds=[(-3,0),(0,8),(0,2),(0,0),
     (-20,0),(-3,0),(0,20),(0,3),
     (-20,0),(-3,0),(0,20),(0,3),
...
heterocyls=['ttm','ptm','c_01','m1ttm_truncated',
            ...
            'TTM_Bi3', 'TTM_dacz',
             ...
             'TTM-DAbCz', 'PyBTM-TPAP', 'MetaPyBTM-TPA-Me2']
...
hetero_data={'ttm':[544,374,850/38150],'ptm':[570,386,0.13/2.6],'c_01':[573,385,0.04/0.7],'m1ttm_truncated':[544,374,850/3.815E+04],
             ...
             'TTM-alphaPyID':[586.79, 373.58, 1/0.09999999999999964 ], 'TTM-gammaPyID':[598, 373,1.011627906976745/0.11627 ],
             'TTM-deltaPyID':[621.28, 403.063,1.0169/ 0.13559 ],'TTM_dacz':[565, 373], 'TTM_DACzp':[570, 375],'TTM_AID':[563, 375],'TTM_DAID':[558, 375]
             ...
             'PyBTM-TPAP':[714, 380], 'MetaPyBTM-TPA-Me2':[828, 390], 'TTM-betaPyID':[609, 405, 1/ 0.0431424 ]
             }
opt= False
