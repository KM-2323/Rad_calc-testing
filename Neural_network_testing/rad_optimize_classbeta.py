...
# for N (alphan,Acn,bcn,Unn,r0nn), for N2 (alphan2,Acn2,bcn2,Un2n2,r0n2n2) and for Cl (alphacl,Accl,bccl,Uclcl,r0clcl)
        C_str = (
            f"\nCarbon parameters in current iteration: \n"
            f"A = {active_params[0][0]:.6f}, b = {active_params[0][1]:.6f}, "
            f"U = {active_params[0][2]:.6f}, r0 = {active_params[0][3]:.6f}\n"
            f'sanity = {active_params[0][4]}\n'
        )
        N_str = (
            f"\nPyridine Nitrogen parameters in current iteration: \n"
            f"alphan = {active_params[1][0]:.6f}, Acn = {active_params[1][1]:.6f}, "
            f"bcn = {active_params[1][2]:.6f}, Unn = {active_params[1][3]:.6f},"
            f'r0nn = {active_params[1][4]}\n'
            f"\nPyrole Nitrogen parameters in current iteration: \n"
            f"alphan2 = {active_params[2][0]:.6f}, Acn2 = {active_params[2][1]:.6f}, "
            f"bcn2 = {active_params[2][2]:.6f}, Un2n2 = {active_params[2][3]:.6f},"
            f'r0n2n2 = {active_params[2][4]}\n'
            f"\nChlorine parameters in current iteration: \n"
            f"alpha_cl = {active_params[3][0]:.6f}, Accl = {active_params[3][1]:.6f}, "
            f'bccl ={active_params[3][2]:.6f} , Uclcl = {active_params[3][3]:.6f},' 
            f'r0clcl = {active_params[3][4]:.6f}\n'
    ...
    def optimize_chlorine(self):
        ...
        optimize.minimize(self.fitness, active, args=(inactive, self.weights, self.atom), method='nelder-mead', 
                        #   bounds=((-20, 0), (-2.6, 0), (0, 5.3), (0, 2)), 
    ...
    def optimize_carbon(self):
        ...
        bds = [(-20, 0), (-2.6, 0), (0, 5.3), (0, 2)]
        fnl_rlt = optimize.minimize(self.fitness, active, args=(inactive, self.weights, self.atom), method='nelder-mead', 
                                    # bounds=bds, 
                                     options={'maxiter': 1000, 'disp': True, 'fatol': 1e-6, 'xatol': 1e-6})
